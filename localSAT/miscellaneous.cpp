...
void printUsage(){
	...
	printf("   -eps <float value> [0.0,1.0] :  [default = 1.0]\n");
	printf("   -cb <float value>  [2.0,10.0] : constant for break\n");
	printf("   -cm <float value>  [-2.0,2.0] : constant for make\n");
	printf("\n");
	...
	printf("   -flips  <long long int_value>,   : maximum number of flips per try \n");
